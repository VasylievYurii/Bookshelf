      ...
      there is no description for this book</p>`:n}</p>
         ...
         <ul class="shopping-links">
          ...
          <button class="sh-list-delete-btn" type="button">
           ...
           `).join("\n");S.shoppingListEl.innerHTML=t,setTimeout(()=>{v()},0),setTimeout(()=>{v()},0)}(e)}L(_);const w=document.querySelector(".shopping-list");w.addEventListener("click",function(e){if("BUTTON"===e.target.nodeName||"use"===e.target.nodeName){let o=_.findIndex(o=>o._id===e.target.closest(".shopping-list-item").getAttribute("id"));-1!==o&&(_.splice(o,1),localStorage.setItem(E,JSON.stringify(_))),S.shoppingListEl.innerHTML="",L(_),(0,f.shopingListCounter)()}}),n("fMzCF"),n("74Aiq"),n("epHO8");var H=n("9OeKo");function A(){let e=Math.max(document.documentElement.clientWidth||0,window.innerWidth||0);return{width:e}}function x(){let e=A(),o=document.querySelector(".sidebar");e.width<1440?o.classList.add("visually-hidden"):o.classList.remove("visually-hidden")}A(),x(),window.addEventListener("resize",o(H)(x,500));const F=document.querySelector(".header-shopping-link");F.classList.add("current");
//# sourceMappingURL=shopping-list.f1e9d6f2.js.map
