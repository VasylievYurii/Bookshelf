      ...
      there is no description for this book</p>`:`<p class="sh-book-description">${n}</p>`}</p>
         ...
         <ul class="shopping-links">
                            <li class="sh-soc-item">
                              <a class="sh-soc-link" href="${h[0].url}" rel="noopener noreferrer nofollow"
            target="_blank"> 
            <img srcset="${o(l)} 1x, ${o(a)} 2x" 
            src="${o(l)}" class="amazon-store"
            alt="Amazon Store ${h[0].name}"/>
                              </a>
                            </li>
                            <li class="sh-soc-item">
                              <a class="sh-soc-link" href="${h[1].url}" rel="noopener noreferrer nofollow"
            target="_blank">
                            <img srcset="${o(p)} 1x, ${o(c)} 2x" 
                            src="${o(p)}" class="apple-store"
                            alt="Apple Store ${h[1].name}"/>
                             </a>
                            </li>
                           <li class="sh-soc-item">
                          <a class="sh-soc-link" href="${h[4].url}" rel="noopener noreferrer nofollow"
            target="_blank">
            <img srcset="${o(u)} 1x, ${o(f)} 2x" 
            src="${o(u)}" class="book-shop"
            alt="Book Shop ${h[4].name}"/>
                         </a>
                       </li>
                      </ul>
      </div>
...
//# sourceMappingURL=shopping-list.e747992e.js.map
