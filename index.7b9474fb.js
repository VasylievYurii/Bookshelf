var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},o={},n=e.parcelRequired7c6;null==n&&((n=function(e){if(e in t)return t[e].exports;if(e in o){var n=o[e];delete o[e];var l={id:e,exports:{}};return t[e]=l,n.call(l.exports,l,l.exports),l.exports}var c=Error("Cannot find module '"+e+"'");throw c.code="MODULE_NOT_FOUND",c}).register=function(e,t){o[e]=t},e.parcelRequired7c6=n),n("2wbaf"),n("4dIBK");var l=n("d5eID"),c=n("fMzCF");const i=(0,l.useBooksApi)(),s=document.querySelector(".section-categories"),a=document.querySelector(".section-books"),r=document.querySelector(".section-books-title"),d=document.querySelector(".section-books-list");function u(e,t){let o=t?"element-books-list-all":"element-books-list",n=e.map(({book_image:e,title:t,author:n,_id:l})=>`<li class="${o}">
    <a class='book-item' data-value="${l}">
  ...
  </li>`).join("\n");return n}async function f(e){console.log(e);try{let t=await i.getBooksByCategory(e);d.innerHTML=u(t,!0),r.innerHTML=function(e){let t=e.split(" ");if(t.length<2)return`${e}`;let o=t.pop();return`${t.join(" ")} <span class="accent">${o}</span>`}(e),function(e){e.classList.add("hidden")}(s),function(e){e.classList.remove("hidden")}(a),d.addEventListener("click",g)}catch(e){console.log(e)}}function g(e){let t=e.target.closest(".book-item");if(!t)return;let o=t.getAttribute("data-value");i.getBookById(o).then(c.insertModalBook).catch(e=>console.log(e)),(0,c.onModalOpen)()}var l=n("d5eID");const y=(0,l.useBooksApi)(),k=document.querySelector(".section-categories-list");function m(e){if(e.preventDefault(),"BUTTON"===e.target.nodeName){let t=e.target.closest(".category-block").getAttribute("data-category");f(t);return}}!async function(){try{let e=await y.getCategoryList(),t=[...new Set(e.map(({list_name:e})=>e))].sort();k.innerHTML=function(e){let t=e.map(e=>`<li class='category-block' data-category="${e}">
      ...
      </li>`}).join("");b.insertAdjacentHTML("beforeend",o),v.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault(),v.forEach(e=>e.classList.remove("active")),e.classList.add("active")})})};p.getCategoryList().then(e=>{h(e)}).catch(e=>{console.log(e)}).finally(()=>{}),b.addEventListener("click",function(e){e.preventDefault();let t=e.target.closest(".category-link");if(!t)return;let o=t.textContent.trim();if("All categories"===o){console.log("first");let e=document.querySelector(".section-books");e.innerHTML="";let t=document.querySelector(".section-categories");t.classList.remove("hidden")}else f(o)}),n("ld1e2"),n("dTazW"),n("4EhXu"),n("fMzCF"),n("74Aiq"),n("epHO8");const L=document.querySelector(".header-link-home");L.classList.add("current");
//# sourceMappingURL=index.7b9474fb.js.map
